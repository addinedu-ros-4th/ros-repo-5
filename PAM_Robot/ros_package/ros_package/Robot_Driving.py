...
class RobotDriver(Node):
    def __init__(self):
        ...
        self.goal_poses_art = ['강아지','not_item','고양이','초록양','not_item','갈색말'] # 작품위치에 따른 작품명
    ...
    def handle_guide(self, description):
        ...
        self.description_index = self.art_index
    ...
    def comeback_to_patrol(self):
        ...
        # 현재 위치 업데이트
        self.current_segment_index = self.description_index
